                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                IconButton {
                                    ...
                                    z: 4
                                    anchors.top: parent.top
                                    anchors.right: clipItemExpandIcon.visible ? clipItemExpandIcon.left : parent.right
                                    anchors.topMargin: clipboardWindow.s(12.8)
                                    anchors.rightMargin: clipboardWindow.s(clipItemExpandIcon.visible ? 6 : 8)
                                    size: clipboardWindow.s(26.4)
                                    cornerRadius: clipboardWindow.s(6.6)
                                    buttonIcon: "󰐃"
                                    iconFontSize: clipboardWindow.s(13)
                                    action_highlight: Boolean(model.pinned)
                                    accentColor: model.pinned ? ThemeBackend.mauve : ((!clipDelegateCard.isImage && clipDelegateWrapper.isSelected) ? Qt.rgba(0, 0, 0, 0.15) : ThemeBackend.surface2)
                                    textColor: model.pinned ? ThemeBackend.crust : ((!clipDelegateCard.isImage && clipDelegateWrapper.isSelected) ? (isHoveredOrHighlighted ? ThemeBackend.base : ThemeBackend.crust) : (isHoveredOrHighlighted ? ThemeBackend.text : ThemeBackend.subtext1))
                                    onClicked: {
                                        clipList.currentIndex = index;
                                        clipboardWindow.pinClip(clipDelegateWrapper.clipIdString, index);
                                    }
                                ...
                                Item {
                                    ...
                                    anchors.leftMargin: clipboardWindow.s(8)
                                    anchors.right: parent.right
                                    anchors.rightMargin: clipDelegateCard.canExpand ? clipboardWindow.s(70) : clipboardWindow.s(38)
                                    anchors.top: parent.top
                                ...
                                Item {
                                    ...
                                    anchors.rightMargin: clipDelegateCard.canExpand ? clipboardWindow.s(74) : clipboardWindow.s(36)
                                    clip: true

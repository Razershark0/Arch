...
Item {
    ...
    Canvas {
        ...
        visible: solidBackground.visible && contentWrapper.isFill && (barWindow ? !barWindow.positionChanging : true)
    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            color: (contentWrapper.isSolid && contentWrapper.distinctPills)
                ? Qt.alpha("#110915", (barWindow && barWindow.barOpacity !== undefined) ? barWindow.barOpacity : 1.0)
                : Qt.alpha(ThemeBackend.base, (barWindow && barWindow.barOpacity !== undefined) ? barWindow.barOpacity : 1.0)
            radius: barWindow ? barWindow.s((contentWrapper.isSolid && contentWrapper.distinctPills) ? 9 : 10) : ((contentWrapper.isSolid && contentWrapper.distinctPills) ? 9 : 10)
            border.width: 0
    ...
    MediaWidget {
        ...
        visible: contentWrapper.isModuleActive("media") && mediaWidget.isMediaActive
        barWindow: contentWrapper.barWindow
        isSolid: contentWrapper.isSolid || contentWrapper.isFill
        distinctPills: contentWrapper.distinctPills
        contentWrapperWidth: contentWrapper.width
        moduleActive: contentWrapper.isModuleActive("media") && mediaWidget.isMediaActive
    ...
    PowerWidget {
        ...
        z: 1
        x: targetX
        y: contentWrapper.getModuleY(powerWidget)
        visible: contentWrapper.isModuleActive("power")
        barWindow: contentWrapper.barWindow
        isSolid: contentWrapper.isSolid || contentWrapper.isFill
        distinctPills: contentWrapper.distinctPills
        moduleActive: contentWrapper.isModuleActive("power")
        isGrouped: contentWrapper.isModuleGrouped("power")
        targetX: contentWrapper.getModuleX("power", contentWrapper.layoutState)
